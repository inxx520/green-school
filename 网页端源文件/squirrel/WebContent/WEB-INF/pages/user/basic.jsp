...
<div class="pre-2" id="big_img">
	...
	<div id="cover" style="min-height: 800px;">
    ...
    font-weight: bolder;margin-top:10px;">校园闲置物品租借平台</em> <em class="em3"></em>
				</a>
			...
			<div id="user_content">
				<div class="basic">
					<form:form action="../user/updateInfo" method="post"
						...
						<h1 style="text-align: center;font-size:24px;color:#333333">完善与修改个人信息</h1>
						<hr />
