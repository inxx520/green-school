    ...
    font-weight: bolder;">校园闲置物品租借平台</em> <em class="em3"></em>
						...
						<li class="changemore"><a class="changeMoreVertShow()"> <i
							...
							<div class="more-vert">
								<ul class="dropdown-content">
									...
									<li><a href="<%=basePath%>user/allFocus">我的预约</a></li>
        ...
        -->
			<div id="user_nav">
				...
				<div class="home_nav" style="min-height:300px;">
					<ul style="min-height:300px;">
						...
						<a href="<%=basePath%>user/allFocus">
							<li class="fri">
								<div></div> <span>预约列表</span> <strong></strong>
						</li>
						</a>
        ...
        -->
			<div id="user_content" >
				<div class="share" style="margin-top:0px; margin-left:150px;">
					<!--
          	...
          	<!--
                ...
                -->
					<div class="share_content">
						...
						<c:if test="${notice!=null}">
							...
							<div class="yes_share">
								<h1 style="text-align: center;font-size:24px;color:#333333">求租信息</h1>
								<hr id="hr1">
								...
								<div id="share_box">
									<button type="button" class="btn btn-info"
										...
										style="background-color: #ffba63; border: 0px; outline: none;">${item.user.username}</button>
                ...
                <hr id="hr1">
					...
					<div class="publish">
						...
						<div class="button" style="background-color:#ffffff;">
							<!-- 
                         ...
                         -->
							<div class="checkbox" style="width: 135px;background-color:#ffffff;">
