...
-->
	<div ng-controller="sidebarController"
		class="sidebar stark-components ng-scope" style="border-radius:10px;">
...
-->
	<div class="main-content">
        ...
        描述：右侧banner（图片）部分
    -->
		<div class="slider-wapper" style="border-radius:30px;">
			<div class="slider" style="height: 440px; touch-action: pan-y; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);border-radius:30px;">
				<ul class="slides" style="height: 400px;border-radius:30px;">
					<li class="active" style="opacity: 1;"><a
						href="<%=basePath%>goods/homeGoods">
							<div class="bannerimg"  style="border-radius:30px;">
								<ul class="bannerul">
									<p class="text1">Hello：</p>
									<p class="text2">欢迎来到【易物】校园闲置物品租借平台。临近毕业季的</p>
									<p class="text3">你，是否有太多的闲置与校友分享，为了追求更好的校园服</p>
									<p class="text4">
										务，我们打造了一个全新的校园平台——<span>易租校园闲置物品租借平台
									</p>
									<p class="text5">这里有更多的闲置分享，更自由的校园话题讨论，你想要的，都在这里。</p>
									<p class="text6">加入易租校园闲置物品租借平台，你的大学，应更精彩。</p>
								</ul>
								<!--   <div class="logoimg">
    ...
    -->
		...
		<div class="info" style="margin-left:350px;	margin:0 auto;
	text-align:center;">
			<a href="#">关于我们</a><em>-</em> <a href="#">联系我们</a>
			<br><br>
			<p>©2020 易物校园闲置物品租赁交易平台</p>
		</div>
	</div>
</body>
</html>