        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../goods/publishGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    <h1 style="margin-left:210px;font-size:28px;text-align:center">发布物品</h1>
                    ...
                    <input type="submit" class="setting-save" value="发布物品" style="margin-left:300px;margin-top: 20px;background-color:#ffba63;"/>
                </form:form>
            </div>
            <!--
