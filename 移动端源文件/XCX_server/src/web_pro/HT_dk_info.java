...
/**
 * Servlet implementation class HT_dk_info
 */
@WebServlet("/HT_dk_info")
public class HT_dk_info extends HttpServlet {
      ...
      //-------------------------------------------------------
      	...
      	try {
  			...
  			while(rs.next())  
  				...
  				Ostr=Ostr+"\"SPNUM\":\""+rs.getString("spnum")+"\", ";
  				...
  				Ostr=Ostr+"\"SPCHECK\":\""+rs.getString("spcheck")+"\",";
