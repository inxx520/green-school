...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
    ...
    //-------------------------------------------------------
    	...
    	String Sql_str = "select * from xyh_data where YH_log='"+log+"' and YH_pwd='"+pwd+"'";
    	String Sql_str1 = "select * from xyh_data order by YH_num";
    	String Ostr="";
    	String Ostr1="";
    	try {
			...
			while(rs1.next()) {
			Ostr1=Ostr1+"{\"YHNUM\":\""+rs1.getString("YH_num")+"\", ";
