...
/**
 * Servlet implementation class PG_gps
 */
@WebServlet("/PG_gps")
public class PG_gps extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//response.getWriter().append("Served at: ").append(request.getContextPath());
		        ...
		        //-------------------------------------------------------
					...
					String Ostr="";
					System.out.println(Double.parseDouble(GPS_jl));
					if (Double.parseDouble(GPS_jl) <=20000){
